...
user_3 = User.create(email: 'jp@lewagon.com', password: "password", address: '6 rue royale, Orleans', rating: 5, username: "JP", admin: false)
user_4 = User.create(email: 'jj@lewagon.com', password: "password", address: '19 place de la gare, Lyon', rating: 5, username: "JJ", admin: false)
user_5 = User.create(email: 'ja@lewagon.com', password: "password", address: '5 rue chavanne, Lyon', rating: 5, username: "JA", admin: false)
user_6 = User.create(email: 'jz@lewagon.com', password: "password", address: '12 boulevard Montparnasse, Paris', rating: 5, username: "JZ", admin: false)
user_7 = User.create(email: 'je@lewagon.com', password: "password", address: '24 rue Grignan, Marseille', rating: 5, username: "JE", admin: false)
user_8 = User.create(email: 'jr@lewagon.com', password: "password", address: '44 la canebiere, Marseille', rating: 5, username: "JR", admin: false)
user_9 = User.create(email: 'jt@lewagon.com', password: "password", address: '10 rue Sainte, Marseille', rating: 5, username: "JT", admin: false)
user_10 = User.create(email: 'jy@lewagon.com', password: "password", address: '1 boulevard Perrier, Marseille', rating: 5, username: "JY", admin: false)
user_11 = User.create(email: 'ju@lewagon.com', password: "password", address: '94 rue Grignan, Marseille', rating: 5, username: "JU", admin: false)
user_12 = User.create(email: 'ji@lewagon.com', password: "password", address: '134 rue du paradis, Marseille', rating: 5, username: "JI", admin: false)
user_13 = User.create(email: 'jo@lewagon.com', password: "password", address: '14 boulevard Voltaire, Paris', rating: 5, username: "JO", admin: false)
user_14 = User.create(email: 'jq@lewagon.com', password: "password", address: '45 boulevard Carnot, Lille', rating: 5, username: "JQ", admin: false)
user_15 = User.create(email: 'js@lewagon.com', password: "password", address: '8 rue de Prague, Paris', rating: 5, username: "JS", admin: false)
...
jp = Otter.new(name: 'Jean-Pierre', age: 53, personality: "talker", rating: 5, user_id: user_2.id)
...
marcelle = Otter.create(name: 'Marcelle', age: 2, personality: "shy", rating: 5, user_id: user_3.id)
...
louma = Otter.create(name: 'Louma', age: 9, personality: "crazy", rating: 5, user_id: user_4.id)
...
victoire = Otter.create(name: 'Victoire', age: 5, personality: "cute", rating: 5, user_id: user_5.id)
...
noemie = Otter.create(name: 'Noémie', age: 12, personality: "worker", rating: 5, user_id: user_6.id)
...
remy = Otter.create(name: 'Remy', age: 5, personality: "smart", rating: 5, user_id: user_7.id)
...
aymeric2 = Otter.create(name: 'Aymeric2', age: 8, personality: "wild", rating: 5, user_id: user_8.id)
...
bigbiz = Otter.create(name: 'Bigbiz', age: 9, personality: "funny", rating: 5,user_id: user_9.id)
...
lola = Otter.create(name: 'Lola', age: 1, personality: "sleepy", rating: 5, user_id: user_10.id)
...
mirabelle = Otter.create(name: 'Mirabelle', age: 10, personality: "funny", rating: 5,user_id: user_11.id)
...
jc = Otter.create(name: 'Jean-Claude', age: 5, personality: "late", rating: 5, user_id: user_12.id)
...
jm = Otter.create(name: 'Jean-Marc', age: 9, personality: "very late", rating: 5, user_id: user_13.id)
...
jp = Otter.create(name: 'Jean-Pierre', age: 4, personality: "worker", rating: 5,user_id: user_14.id)
jp.address = jp.user.address
jp.save
file14 = URI.open('https://static.lpnt.fr/images/2018/12/21/17792283lpw-17792282-article-jpg_5825528.jpg')
jp.photo.attach(io: file14, filename: 'jp.jpg', content_type: 'image/jpg')

jd = Otter.create(name: 'Jean-David', age: 1, personality: "winner", rating: 5, user_id: user_15.id)
